...
All files in the OASIS/ directory are the publicly released files from the Oasis model, which we tested on our dataset with its pre-trained weights. 
All other files are created by us.
